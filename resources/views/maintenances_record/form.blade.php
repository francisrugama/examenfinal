        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="date" id="entry_date" name="entry_date" class="form-control form-control-alternative"
                    ...
                    value="{{ old('entry_date', $maintenance_record->entry_date) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="date" id="delivery_date" name="delivery_date" class="form-control form-control-alternative"
                    ...
                    value="{{ old('delivery_date', $maintenance_record->delivery_date) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="current_mileage" name="current_mileage" class="form-control form-control-alternative"
                    ...
                    value="{{ old('current_mileage', $maintenance_record->current_mileage) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="work_description" name="work_description" class="form-control form-control-alternative"
                    ...
                    value="{{ old('work_description', $maintenance_record->work_description) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="parts_cost" name="parts_cost" class="form-control form-control-alternative"
                    ...
                    value="{{ old('parts_cost', $maintenance_record->parts_cost) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="labor_cost" name="labor_cost" class="form-control form-control-alternative"
                    ...
                    value="{{ old('labor_cost', $maintenance_record->labor_cost) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="total_cost" name="total_cost" class="form-control form-control-alternative"
                    ...
                    value="{{ old('total_cost', $maintenance_record->total_cost) }}">
            </div>
        </div>
    </div>
            ...
            <div class="form-group-label" for="maintenance_record_id">
                ...
                <select name="vehicle_id" id="vehicle_id" class="form-control form-control-alternative">
                    ...
                    @foreach ($vehicles as $vehicle)
                        <option value="{{ $vehicle->id }}" @selected(old('vehicle_id', $maintenance_record->vehicle_id) == $vehicle->id)>
                            {{ $vehicle->name }}
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group-label" for="maintenance_record_id">
                ...
                <select name="client_id" id="client_id" class="form-control form-control-alternative">
                    ...
                    @foreach ($clients as $client)
                        <option value="{{ $client->id }}" @selected(old('client_id', $maintenance_record->client_id) == $client->id)>
                            {{ $client->name }}
                    @endforeach
                </select>
            </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group-label" for="maintenance_record_id">
                ...
                <label>
                <select name="technician_id" id="technician_id" class="form-control form-control-alternative">
                    <option disabled selected>Seleccionar un técnico</option>
                    @foreach ($technicians as $technician)
                        <option value="{{ $technician->id }}" @selected(old('technician_id', $maintenance_record->technician_id) == $technician->id)>
                            {{ $technician->name }}
                    @endforeach
                </select>
            </div>
