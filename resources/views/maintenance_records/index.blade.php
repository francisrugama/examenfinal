            ...
            <div class="card shadow">
                ...
                <div class="card-header border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('maintenance_records.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($maintenance_records as $maintenance_record)
                                <tr>
                                    ...
                                    <td>{{ $maintenance_record->technican->name}}</td>
                                    <td>{{ $maintenance_record->created_at}}</td>

                                    <td style="white-space: nowrap; display: flex; align-items: center;">
                                        <a href="{{ route('maintenance_records.show', $maintenance_record->id) }}" class="btn btn-primary btn-sm" style="margin-right: 7px">
                                            <i class="fas fa-eye"></i> Mostrar
                                        </a>

                                        <a href="{{ route('maintenance_records.edit', $maintenance_record->id) }}" class="btn btn-info btn-sm" style="margin-right: 7px">
                                            <i class="fas fa-edit"></i> Editar
                                        </a>
                                        <form action="{{ route('maintenance_records.destroy', $maintenance_record->id) }}" method="POST"
