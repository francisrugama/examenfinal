...
<div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="date" id="service_type" name="service_type" class="form-control form-control-alternative"
                    placeholder="Ingresar el tipo de servicio"
                    value="{{ old('service_type', $service_detail->service_type) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="tex" id="tool_used" name="tool_used" class="form-control form-control-alternative"
                    ...
                    value="{{ old('tool_used', $service_detail->tool_used) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="warranty_service" name="warranty_service" class="form-control form-control-alternative"
                    ...
                    value="{{ old('warranty_service', $service_detail->warranty_service) }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="observations" name="observations" class="form-control form-control-alternative"
                    ...
                    value="{{ old('observations', $service_detail->observations) }}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group-label" for="services_details_id">
                ...
                <select name="technician_id" id="technician_id" class="form-control form-control-alternative">
                    ...
                    @foreach ($technicians as $technician)
                        <option value="{{ $technician->id }}" @selected(old('technician_id', $service_detail->technician_id) == $technician->id)>
                            {{ $technician->entry_date }}
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="form-group-label" for="services_details_id">
                ...
                <select name="maintenance_record_id" id="maintenance_record_id" class="form-control form-control-alternative">
                    ...
                    @foreach ($maintenances_record as $maintenance_record)
                        <option value="{{ $maintenance_record->id }}" @selected(old('maintenance_record_id', $service_detail->maintenance_record_id) == $maintenance_record->id)>
