...
use App\Http\Controllers\Servive_historyController;
use App\Http\Controllers\Spare_usedController;
use App\Http\Controllers\Technician_assignmentController;
...
Route::middleware('auth')->group(function () {
    ...
    //rutas de posts de tipo resource
     ...
     Route::resource('/maintenances_record', Maintenance_recordController::class);
     Route::resource('/appointments', AppointmentsController::class);
     Route::resource('/services_details', Service_detailController::class);
     Route::resource('/services_historys', Service_historyController::class);
     Route::resource('/spares_useds', Spare_usedController::class);
     Route::resource('/technicians_assignments', Technician_assignmentController::class);
